...
import profile_img from "../images/Profile_Image1.jpg";
    ...
    <>
      <div id="about" className=" relative flex flex-col md:overflow-hidden bg-[#202020] w-screen md:w-auto text-white h-auto md:px-20 px-2 py-5 md:py-10">
        ...
        <div className="flex z-10 flex-col md:flex-row px-4 lg:px-0 justify-between align-middle items-center gap-5 md:gap-10">
          <div className="font-BarlowCondensed font-bold leading-[4.5rem] text-[50px]  md:text-[80px] uppercase">
            Hello <span className="text-purple-500">Everyone</span>
          </div>
          <div className="font-HankenGrotesk text-[#cfcfcf] font-medium text-xl md:text-lg">
        ...
        <div className="relative z-10 h-auto w-[300px] md:w-[400px] flex justify-center rounded-lg overflow-hidden items-center">
          ...
          <div className="flex flex-col md:flex-row justify-center md:ml-[100px] items-center align-middle">
            <a
              href=""
        ...
        <div className="z-0 items-center flex justify-center font-BarlowCondensed uppercase opacity-30 mt-[-150px] text-white text-[60px] md:text-[160px] font-bold">
          Pranay Shelar
        </div>
      </div>
    </>
